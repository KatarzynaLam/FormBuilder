...
var findChild = (tab, childClass, parentType)=>{
    ...
    if (tab.childTab == undefined) tab.childTab = {};
    if (child != null) {
        //parentTab[i].childTab={}
        findChild(tab.childTab[amountOfChildren], child, parentType);
        var nextChild = childClass.nextChild;
        amountOfChildren += 1;
        if (nextChild != null) findChild(tab.childTab[amountOfChildren], nextChild, parentType);
        else {
...
//# sourceMappingURL=formBuilder.f20f4dac.js.map
